...
<div class="container-fluid">
    <legend>
        <div class="fa-2x">
            ...
            <i class="text fa-1x">RattlerStation: enjoy your rattler</i>
            <i class="fab fa-fort-awesome"></i>
        </div>
    </legend>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                <a class="navbar-brand fas fa-hamsa" href="#"></a>
            </div>
            <ul class="nav navbar-nav">
                <li class="active"><a href="#"><i class="fas fa-home fa-1x"></i> Home</a></li>
            </ul>
        </div>
    </nav>
</div>
